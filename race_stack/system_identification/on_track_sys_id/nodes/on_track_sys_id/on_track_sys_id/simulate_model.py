...
from on_track_sys_id.vehicle_dynamics_stown import vehicle_dynamics_st
from on_track_sys_id.load_model import get_dotdict
...
class LookupGenerator:
  ...
  def run_generator(self):
    ...
    if PLOT_LOOKUP:
      # self.logger.warn("Lookup Table has been generated. Close the plot window (press Q) to save the lookup table.")
      print("Lookup Table has been generated. Close the plot window (press Q) to save the lookup table.")
      self.plot_lookup()
    self.save_lookup()
